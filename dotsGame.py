...
class GameDots:
    ...
    def play_game(self):
        ...
        while True:
            if gf.is_game_mode:
                gui0.draw_dropdown(gf.screen, "Режим игры", ["с друзьями", "с компьютером"], "Продолжить", "с друзьями",
                                   30, 40)
                ...
                gui2.draw_dropdown(gf.screen, "Размер поля", ["10", "13", "15", "18", "21", "23", "26", "28", "31",
                                                              "33", "36", "38", "40"], "Начать игру", "10", 30, 40)
            else:
